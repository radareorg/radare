...
#line 23 "/home/pancake/prg/pvcroot/radare/vala/grava/home/pancake/prg/pvcroot/radare/vala/grava/layout.vala"
static void grava_layout_real_run (GravaLayout* self, GravaGraph* graph) {
#line 23 "/home/pancake/prg/pvcroot/radare/vala/grava/home/pancake/prg/pvcroot/radare/vala/grava/layout.vala"
...
static void grava_layout_init (GravaLayout * self) {
}


GType grava_layout_get_type (void) {
	static GType grava_layout_type_id = 0;
	if (G_UNLIKELY (grava_layout_type_id == 0)) {
		static const GTypeInfo g_define_type_info = { sizeof (GravaLayoutClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) grava_layout_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (GravaLayout), 0, (GInstanceInitFunc) grava_layout_init };
