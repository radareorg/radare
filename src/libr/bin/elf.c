...
char* ELF_(r_bin_elf_get_arch)(ELF_(r_bin_elf_obj) *bin)
{
...
char* ELF_(r_bin_elf_get_data_encoding)(ELF_(r_bin_elf_obj) *bin)
{
...
char* ELF_(r_bin_elf_get_machine_name)(ELF_(r_bin_elf_obj) *bin)
{
...
char* ELF_(r_bin_elf_get_file_type)(ELF_(r_bin_elf_obj) *bin)
{
...
char* ELF_(r_bin_elf_get_elf_class)(ELF_(r_bin_elf_obj) *bin)
{
...
char* ELF_(r_bin_elf_get_osabi_name)(ELF_(r_bin_elf_obj) *bin)
{
