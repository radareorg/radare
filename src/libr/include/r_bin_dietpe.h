...
int dietpe_get_exports(dietpe_bin*, dietpe_export*);
int dietpe_get_exports_count(dietpe_bin*);
int dietpe_get_file_alignment(dietpe_bin*);
PE_DWord dietpe_get_image_base(dietpe_bin*);
int dietpe_get_image_size(dietpe_bin*);
int dietpe_get_imports(dietpe_bin*, dietpe_import*);
int dietpe_get_imports_count(dietpe_bin*);
