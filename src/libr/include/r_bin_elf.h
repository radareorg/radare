...
char* ELF_(r_bin_elf_get_arch)(ELF_(r_bin_elf_obj)*);
u64   ELF_(r_bin_elf_get_base_addr)(ELF_(r_bin_elf_obj)*);
char* ELF_(r_bin_elf_get_data_encoding)(ELF_(r_bin_elf_obj)*);
char* ELF_(r_bin_elf_get_elf_class)(ELF_(r_bin_elf_obj)*);
u64   ELF_(r_bin_elf_get_entry_offset)(ELF_(r_bin_elf_obj)*);
char* ELF_(r_bin_elf_get_file_type)(ELF_(r_bin_elf_obj)*);
...
int   ELF_(r_bin_elf_get_libs)(ELF_(r_bin_elf_obj)*, int, int, r_bin_elf_string*);
char* ELF_(r_bin_elf_get_machine_name)(ELF_(r_bin_elf_obj)*);
char* ELF_(r_bin_elf_get_osabi_name)(ELF_(r_bin_elf_obj)*);
u64   ELF_(r_bin_elf_get_section_index)(ELF_(r_bin_elf_obj)*, const char*);
u64   ELF_(r_bin_elf_get_section_offset)(ELF_(r_bin_elf_obj)*, const char*);
int   ELF_(r_bin_elf_get_section_size)(ELF_(r_bin_elf_obj)*, const char*);
...
int   ELF_(r_bin_elf_get_strings)(ELF_(r_bin_elf_obj)*, int, int, int, r_bin_elf_string*);
...
int   ELF_(r_bin_elf_open)(ELF_(r_bin_elf_obj)*, const char*);
